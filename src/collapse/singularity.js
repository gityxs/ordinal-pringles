...
let singFunctions = [
    ...
    {requiredLevel: 65, hasUnlock: false, unlockDescription: null, hasEffect: true, effectDescription: '负电荷使ℵ(所有ℵ相加)的效果乘以 ', effect: () => Math.max(1, Math.log2(data.darkness.negativeCharge)), canBePerm: false, permReq: () => false},
